...
interface AIChatNutritionCombinedProps {
  currentView: 'chat' | 'ui';
...
export function AIChatNutritionCombined({
  currentView,
  onViewChange,
  messages,
  setMessages,
          ...
          >
            <Conversation className="h-full">
              <ConversationContent className="max-w-3xl mx-auto w-full p-4 pb-40">
                ...
                {/* Chart position in chat view */}
                {showChart && (
                  <motion.div layout className="mt-6 mb-6">
