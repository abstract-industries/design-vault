...
interface AIChatNutritionMotionProps {
  currentView: 'chat' | 'ui';
...
export function AIChatNutritionMotion({
  currentView,
  onViewChange,
  messages,
  setMessages,
  ...
  return (
    <LayoutGroup>
      <div className="h-full flex flex-col bg-background relative overflow-hidden">
        {/* Chat View Content - Always in DOM */}
        <motion.div
        ...
        >
          <Conversation className="h-full">
            <ConversationContent className="max-w-3xl mx-auto w-full p-4 pb-40">
              ...
              {/* Chart placeholder in chat view */}
              {showChart && isChat && (
        ...
        {/* Single Chart that moves between positions */}
        {showChart && (
          <motion.div
            layout
            ...
            style={{
              left: isChat ? 'auto' : '2rem',
              top: isChat ? 'auto' : '11rem',
              bottom: isChat ? '28rem' : 'auto',
              maxWidth: '24rem',
              width: '100%',
              paddingLeft: isChat ? '1rem' : '0',
              paddingRight: isChat ? '1rem' : '0',
            }}
            animate={{
              x: isChat ? 0 : 0,
            }}
            ...
            onClick={toggleView}
          >
            <div className={isChat ? "max-w-3xl mx-auto" : ""}>
              <div className="w-full max-w-sm">
                <motion.div
